 ...
 */
@ApiModel(description = "The Twitter Topic object.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SpaceTopicsInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "All about technology", value = "The description of the given topic.")
  ...
  **/
  ...
  @ApiModelProperty(example = "848920371311001600", required = true, value = "An ID suitable for use in the REST API.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Technology", required = true, value = "The name of the given topic.")
   ...
   * @return the SpaceTopicsInner instance itself
   */
