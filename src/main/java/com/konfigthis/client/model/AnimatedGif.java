...
public class AnimatedGif extends Media {
  ...
  **/
   ...
   * @return the AnimatedGif instance itself
   */
  public AnimatedGif putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.previewImageUrl, animatedGif.previewImageUrl) &&
        ...
        Objects.equals(this.additionalProperties, animatedGif.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(previewImageUrl, variants, super.hashCode(), additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnimatedGif.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnimatedGif>() {
           ...
           public AnimatedGif read(JsonReader in) throws IOException {
             ...
             AnimatedGif instance = thisAdapter.fromJsonTree(jsonObj);
