 ...
 */
@ApiModel(description = "Nonpublic engagement metrics for the Media at the time of the request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VideoAllOfNonPublicMetrics {
  ...
  **/
   ...
   * @return the VideoAllOfNonPublicMetrics instance itself
   */
  public VideoAllOfNonPublicMetrics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.playback0Count, videoAllOfNonPublicMetrics.playback0Count) &&
        ...
        Objects.equals(this.additionalProperties, videoAllOfNonPublicMetrics.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(playback0Count, playback100Count, playback25Count, playback50Count, playback75Count, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VideoAllOfNonPublicMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VideoAllOfNonPublicMetrics>() {
           ...
           public VideoAllOfNonPublicMetrics read(JsonReader in) throws IOException {
             ...
             VideoAllOfNonPublicMetrics instance = thisAdapter.fromJsonTree(jsonObj);
