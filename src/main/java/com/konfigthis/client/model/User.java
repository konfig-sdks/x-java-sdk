...
import com.konfigthis.client.model.UserEntities;
import com.konfigthis.client.model.UserPublicMetrics;
import com.konfigthis.client.model.UserWithheld;
 ...
 */
@ApiModel(description = "The Twitter User object.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class User {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2013-12-14T04:35:55Z", value = "Creation time of this User.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Twitter Dev", required = true, value = "The friendly name of this User, as shown on their profile.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Indicates if this User has chosen to protect their Tweets (in other words, if this User's Tweets are private).")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "TwitterDev", required = true, value = "The Twitter handle (screen name) of this user.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The Twitter Blue verified type of the user, eg: blue, government, business or none.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, createdAt, entities, id, location, name, pinnedTweetId, profileImageUrl, _protected, publicMetrics, url, username, verified, verifiedType, withheld, additionalProperties);
  }
