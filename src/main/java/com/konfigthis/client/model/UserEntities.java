...
import com.konfigthis.client.model.UserEntitiesUrl;
 ...
 */
@ApiModel(description = "A list of metadata found in the User's profile description.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserEntities {
  ...
  **/
   ...
   * @return the UserEntities instance itself
   */
  public UserEntities putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, userEntities.description) &&
        ...
        Objects.equals(this.additionalProperties, userEntities.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, url, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserEntities.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserEntities>() {
           ...
           public UserEntities read(JsonReader in) throws IOException {
             ...
             UserEntities instance = thisAdapter.fromJsonTree(jsonObj);
