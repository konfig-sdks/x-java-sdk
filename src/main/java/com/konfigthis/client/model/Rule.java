 ...
 */
@ApiModel(description = "A user-provided stream filtering rule.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Rule {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, tag, value, additionalProperties);
  }
