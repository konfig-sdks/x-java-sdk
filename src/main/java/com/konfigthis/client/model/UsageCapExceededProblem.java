 ...
 */
@ApiModel(description = "A problem that indicates that a usage cap has been exceeded.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UsageCapExceededProblem extends Problem {
  ...
  **/
   ...
   * @return the UsageCapExceededProblem instance itself
   */
