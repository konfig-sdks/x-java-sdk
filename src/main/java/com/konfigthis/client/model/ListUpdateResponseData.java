...
public class ListUpdateResponseData {
  ...
  **/
   ...
   * @return the ListUpdateResponseData instance itself
   */
  public ListUpdateResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.updated, listUpdateResponseData.updated)&&
        Objects.equals(this.additionalProperties, listUpdateResponseData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updated, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListUpdateResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListUpdateResponseData>() {
           ...
           public ListUpdateResponseData read(JsonReader in) throws IOException {
             ...
             ListUpdateResponseData instance = thisAdapter.fromJsonTree(jsonObj);
