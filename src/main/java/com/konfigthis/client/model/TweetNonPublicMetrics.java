 ...
 */
@ApiModel(description = "Nonpublic engagement metrics for the Tweet at the time of the request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TweetNonPublicMetrics {
  ...
  **/
   ...
   * @return the TweetNonPublicMetrics instance itself
   */
  public TweetNonPublicMetrics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.impressionCount, tweetNonPublicMetrics.impressionCount)&&
        Objects.equals(this.additionalProperties, tweetNonPublicMetrics.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(impressionCount, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetNonPublicMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetNonPublicMetrics>() {
           ...
           public TweetNonPublicMetrics read(JsonReader in) throws IOException {
             ...
             TweetNonPublicMetrics instance = thisAdapter.fromJsonTree(jsonObj);
