 ...
 */
@ApiModel(description = "A request to create a new batch compliance job.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CreateComplianceJobRequest {
  ...
  **/
   ...
   * @return the CreateComplianceJobRequest instance itself
   */
