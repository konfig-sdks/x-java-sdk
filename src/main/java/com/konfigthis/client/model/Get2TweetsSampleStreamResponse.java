...
public class Get2TweetsSampleStreamResponse {
  ...
  **/
   ...
   * @return the Get2TweetsSampleStreamResponse instance itself
   */
  public Get2TweetsSampleStreamResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, get2TweetsSampleStreamResponse.data) &&
        ...
        Objects.equals(this.additionalProperties, get2TweetsSampleStreamResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Get2TweetsSampleStreamResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<Get2TweetsSampleStreamResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Get2TweetsSampleStreamResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Get2TweetsSampleStreamResponse>() {
           @Override
           ...
           public Get2TweetsSampleStreamResponse read(JsonReader in) throws IOException {
             ...
             Get2TweetsSampleStreamResponse instance = thisAdapter.fromJsonTree(jsonObj);
