 ...
 */
@ApiModel(description = "Promoted nonpublic engagement metrics for the Tweet at the time of the request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TweetPromotedMetrics {
  ...
  **/
   ...
   * @return the TweetPromotedMetrics instance itself
   */
  public TweetPromotedMetrics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.impressionCount, tweetPromotedMetrics.impressionCount) &&
        ...
        Objects.equals(this.additionalProperties, tweetPromotedMetrics.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(impressionCount, likeCount, replyCount, retweetCount, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetPromotedMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetPromotedMetrics>() {
           ...
           public TweetPromotedMetrics read(JsonReader in) throws IOException {
             ...
             TweetPromotedMetrics instance = thisAdapter.fromJsonTree(jsonObj);
