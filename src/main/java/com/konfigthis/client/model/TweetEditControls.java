...
public class TweetEditControls {
  ...
  **/
   ...
   * @return the TweetEditControls instance itself
   */
  public TweetEditControls putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.editableUntil, tweetEditControls.editableUntil) &&
        ...
        Objects.equals(this.additionalProperties, tweetEditControls.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(editableUntil, editsRemaining, isEditEligible, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetEditControls.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetEditControls>() {
           ...
           public TweetEditControls read(JsonReader in) throws IOException {
             ...
             TweetEditControls instance = thisAdapter.fromJsonTree(jsonObj);
