 ...
 */
@ApiModel(description = "An HTTP Problem Details object, as defined in IETF RFC 7807 (https://tools.ietf.org/html/rfc7807).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Problem {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, detail, status, type, additionalProperties);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      switch (discriminatorValue) {
        ...
        case "https://api.twitter.com/2/problems/oauth1-permissions":
          Oauth1PermissionsProblem.validateJsonObject(jsonObj);
          break;
