 ...
 */
@ApiModel(description = "Represents the data for the annotation.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FullTextEntitiesAnnotationsInnerAllOf {
  ...
  **/
   ...
   * @return the FullTextEntitiesAnnotationsInnerAllOf instance itself
   */
