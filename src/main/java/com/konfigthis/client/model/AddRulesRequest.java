...
import com.konfigthis.client.model.RuleNoId;
 ...
 */
@ApiModel(description = "A request to add a user-specified stream filtering rule.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AddRulesRequest {
  ...
  **/
   ...
   * @return the AddRulesRequest instance itself
   */
  public AddRulesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.add, addRulesRequest.add)&&
        Objects.equals(this.additionalProperties, addRulesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(add, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddRulesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddRulesRequest>() {
           ...
           public AddRulesRequest read(JsonReader in) throws IOException {
             ...
             AddRulesRequest instance = thisAdapter.fromJsonTree(jsonObj);
