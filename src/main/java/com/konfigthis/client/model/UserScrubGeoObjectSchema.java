...
public class UserScrubGeoObjectSchema {
  ...
  **/
   ...
   * @return the UserScrubGeoObjectSchema instance itself
   */
  public UserScrubGeoObjectSchema putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventAt, userScrubGeoObjectSchema.eventAt) &&
        ...
        Objects.equals(this.additionalProperties, userScrubGeoObjectSchema.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventAt, upToTweetId, user, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserScrubGeoObjectSchema>() {
           ...
           public UserScrubGeoObjectSchema read(JsonReader in) throws IOException {
             ...
             UserScrubGeoObjectSchema instance = thisAdapter.fromJsonTree(jsonObj);
