 ...
 */
@ApiModel(description = "A problem that indicates a particular Tweet, User, etc. is not available to you.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ResourceUnavailableProblem extends Problem {
  ...
  **/
   ...
   * @return the ResourceUnavailableProblem instance itself
   */
