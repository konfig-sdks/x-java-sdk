...
public class OperationalDisconnectProblemAllOf {
  ...
  **/
   ...
   * @return the OperationalDisconnectProblemAllOf instance itself
   */
  public OperationalDisconnectProblemAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.disconnectType, operationalDisconnectProblemAllOf.disconnectType)&&
        Objects.equals(this.additionalProperties, operationalDisconnectProblemAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disconnectType, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OperationalDisconnectProblemAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if ((jsonObj.get("disconnect_type") != null && !jsonObj.get("disconnect_type").isJsonNull()) && !jsonObj.get("disconnect_type").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OperationalDisconnectProblemAllOf>() {
           ...
           public OperationalDisconnectProblemAllOf read(JsonReader in) throws IOException {
             ...
             OperationalDisconnectProblemAllOf instance = thisAdapter.fromJsonTree(jsonObj);
