 ...
 */
@ApiModel(description = "Specifies the type of attachments (if any) present in this DM.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DmEventAttachments {
  ...
  **/
   ...
   * @return the DmEventAttachments instance itself
   */
  public DmEventAttachments putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cardIds, dmEventAttachments.cardIds) &&
        ...
        Objects.equals(this.additionalProperties, dmEventAttachments.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardIds, mediaKeys, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DmEventAttachments.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DmEventAttachments>() {
           ...
           public DmEventAttachments read(JsonReader in) throws IOException {
             ...
             DmEventAttachments instance = thisAdapter.fromJsonTree(jsonObj);
