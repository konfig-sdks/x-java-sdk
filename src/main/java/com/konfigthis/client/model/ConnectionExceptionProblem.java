 ...
 */
@ApiModel(description = "A problem that indicates something is wrong with the connection.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ConnectionExceptionProblem extends Problem {
  ...
  **/
   ...
   * @return the ConnectionExceptionProblem instance itself
   */
  public ConnectionExceptionProblem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectionIssue, connectionExceptionProblem.connectionIssue)&&
        Objects.equals(this.additionalProperties, connectionExceptionProblem.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectionIssue, super.hashCode(), additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectionExceptionProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConnectionExceptionProblem>() {
           ...
           public ConnectionExceptionProblem read(JsonReader in) throws IOException {
             ...
             ConnectionExceptionProblem instance = thisAdapter.fromJsonTree(jsonObj);
