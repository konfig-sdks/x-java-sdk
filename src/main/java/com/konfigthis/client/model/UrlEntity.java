...
import com.konfigthis.client.model.UrlImage;
 ...
 */
@ApiModel(description = "Represent the portion of text recognized as a URL, and its start and end position within the text.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UrlEntity {
  ...
  **/
  ...
  public UrlEntity status(Integer status) {
    if (status != null && status < 100) {
      throw new IllegalArgumentException("Invalid value for status. Must be greater than or equal to 100.");
    }
  ...
  **/
   ...
   * @return the UrlEntity instance itself
   */
  public UrlEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, urlEntity.end) &&
        ...
        Objects.equals(this.additionalProperties, urlEntity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(end, start, title, description, displayUrl, expandedUrl, images, mediaKey, status, unwoundUrl, url, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UrlEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UrlEntity>() {
           ...
           public UrlEntity read(JsonReader in) throws IOException {
             ...
             UrlEntity instance = thisAdapter.fromJsonTree(jsonObj);
