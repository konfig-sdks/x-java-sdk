...
public class TweetReferencedTweetsInner {
  ...
  **/
   ...
   * @return the TweetReferencedTweetsInner instance itself
   */
  public TweetReferencedTweetsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tweetReferencedTweetsInner.id) &&
        ...
        Objects.equals(this.additionalProperties, tweetReferencedTweetsInner.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetReferencedTweetsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetReferencedTweetsInner>() {
           ...
           public TweetReferencedTweetsInner read(JsonReader in) throws IOException {
             ...
             TweetReferencedTweetsInner instance = thisAdapter.fromJsonTree(jsonObj);
