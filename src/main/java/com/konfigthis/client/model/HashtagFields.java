 ...
 */
@ApiModel(description = "Represent the portion of text recognized as a Hashtag, and its start and end position within the text.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class HashtagFields {
  ...
  **/
   ...
   * @return the HashtagFields instance itself
   */
  public HashtagFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tag, hashtagFields.tag)&&
        Objects.equals(this.additionalProperties, hashtagFields.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HashtagFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HashtagFields>() {
           ...
           public HashtagFields read(JsonReader in) throws IOException {
             ...
             HashtagFields instance = thisAdapter.fromJsonTree(jsonObj);
