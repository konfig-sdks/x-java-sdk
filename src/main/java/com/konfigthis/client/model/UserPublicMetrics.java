 ...
 */
@ApiModel(description = "A list of metrics for this User.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserPublicMetrics {
  ...
  **/
   ...
   * @return the UserPublicMetrics instance itself
   */
