...
import com.konfigthis.client.model.Point;
 ...
 */
@ApiModel(description = "The location tagged on the Tweet, if the user provided one.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TweetGeo {
  ...
  **/
   ...
   * @return the TweetGeo instance itself
   */
  public TweetGeo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.coordinates, tweetGeo.coordinates) &&
        ...
        Objects.equals(this.additionalProperties, tweetGeo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(coordinates, placeId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetGeo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetGeo>() {
           ...
           public TweetGeo read(JsonReader in) throws IOException {
             ...
             TweetGeo instance = thisAdapter.fromJsonTree(jsonObj);
