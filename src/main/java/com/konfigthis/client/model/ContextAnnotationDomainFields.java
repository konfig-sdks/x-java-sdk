 ...
 */
@ApiModel(description = "Represents the data for the context annotation domain.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ContextAnnotationDomainFields {
  ...
  **/
   ...
   * @return the ContextAnnotationDomainFields instance itself
   */
  public ContextAnnotationDomainFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, contextAnnotationDomainFields.description) &&
        ...
        Objects.equals(this.additionalProperties, contextAnnotationDomainFields.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextAnnotationDomainFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContextAnnotationDomainFields>() {
           ...
           public ContextAnnotationDomainFields read(JsonReader in) throws IOException {
             ...
             ContextAnnotationDomainFields instance = thisAdapter.fromJsonTree(jsonObj);
