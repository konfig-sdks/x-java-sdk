 ...
 */
@ApiModel(description = "Organic nonpublic engagement metrics for the Tweet at the time of the request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TweetOrganicMetrics {
  ...
  **/
   ...
   * @return the TweetOrganicMetrics instance itself
   */
  public TweetOrganicMetrics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.impressionCount, tweetOrganicMetrics.impressionCount) &&
        ...
        Objects.equals(this.additionalProperties, tweetOrganicMetrics.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetOrganicMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetOrganicMetrics>() {
           ...
           public TweetOrganicMetrics read(JsonReader in) throws IOException {
             ...
             TweetOrganicMetrics instance = thisAdapter.fromJsonTree(jsonObj);
