...
public class ClientForbiddenProblemAllOf {
  ...
  **/
   ...
   * @return the ClientForbiddenProblemAllOf instance itself
   */
  public ClientForbiddenProblemAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reason, clientForbiddenProblemAllOf.reason) &&
        ...
        Objects.equals(this.additionalProperties, clientForbiddenProblemAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reason, registrationUrl, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClientForbiddenProblemAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClientForbiddenProblemAllOf>() {
           ...
           public ClientForbiddenProblemAllOf read(JsonReader in) throws IOException {
             ...
             ClientForbiddenProblemAllOf instance = thisAdapter.fromJsonTree(jsonObj);
