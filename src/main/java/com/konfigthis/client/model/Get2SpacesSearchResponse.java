...
public class Get2SpacesSearchResponse {
  ...
  **/
   ...
   * @return the Get2SpacesSearchResponse instance itself
   */
  public Get2SpacesSearchResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, get2SpacesSearchResponse.data) &&
        ...
        Objects.equals(this.additionalProperties, get2SpacesSearchResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Get2SpacesSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Get2SpacesSearchResponse>() {
           ...
           public Get2SpacesSearchResponse read(JsonReader in) throws IOException {
             ...
             Get2SpacesSearchResponse instance = thisAdapter.fromJsonTree(jsonObj);
