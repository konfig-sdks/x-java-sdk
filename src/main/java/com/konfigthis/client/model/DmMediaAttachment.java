...
public class DmMediaAttachment {
  ...
  **/
   ...
   * @return the DmMediaAttachment instance itself
   */
  public DmMediaAttachment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mediaId, dmMediaAttachment.mediaId)&&
        Objects.equals(this.additionalProperties, dmMediaAttachment.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DmMediaAttachment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DmMediaAttachment>() {
           ...
           public DmMediaAttachment read(JsonReader in) throws IOException {
             ...
             DmMediaAttachment instance = thisAdapter.fromJsonTree(jsonObj);
