 ...
 */
@ApiModel(description = "Represent the portion of text recognized as a URL.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UrlFields {
  ...
  **/
   ...
   * @return the UrlFields instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, urlFields.title) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, displayUrl, expandedUrl, images, mediaKey, status, unwoundUrl, url, additionalProperties);
  }
