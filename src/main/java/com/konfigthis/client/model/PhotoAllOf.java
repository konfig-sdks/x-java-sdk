...
public class PhotoAllOf {
  ...
  **/
   ...
   * @return the PhotoAllOf instance itself
   */
  public PhotoAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.altText, photoAllOf.altText) &&
        ...
        Objects.equals(this.additionalProperties, photoAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(altText, url, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PhotoAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PhotoAllOf>() {
           ...
           public PhotoAllOf read(JsonReader in) throws IOException {
             ...
             PhotoAllOf instance = thisAdapter.fromJsonTree(jsonObj);
