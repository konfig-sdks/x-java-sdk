...
public class CreateDmConversationRequest {
 ...
 public enum ConversationTypeEnum {
  ...
  private TACreateMessageRequest message;
  ...
  **/
  ...
  public CreateDmConversationRequest message(TACreateMessageRequest message) {
  ...
  **/
  ...
  public TACreateMessageRequest getMessage() {
    return message;
  }


  public void setMessage(TACreateMessageRequest message) {
  ...
  **/
   ...
   * @return the CreateDmConversationRequest instance itself
   */
  public CreateDmConversationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conversationType, createDmConversationRequest.conversationType) &&
        ...
        Objects.equals(this.additionalProperties, createDmConversationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conversationType, message, participantIds, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      TACreateMessageRequest.validateJsonObject(jsonObj.getAsJsonObject("message"));
      // ensure the required json array is present
      if (jsonObj.get("participant_ids") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("participant_ids").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateDmConversationRequest>() {
           ...
           public CreateDmConversationRequest read(JsonReader in) throws IOException {
             ...
             CreateDmConversationRequest instance = thisAdapter.fromJsonTree(jsonObj);
