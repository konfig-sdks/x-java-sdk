 ...
 */
@ApiModel(description = "Specifies the type of attachments (if any) present in this Tweet.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TweetAttachments {
  ...
  **/
   ...
   * @return the TweetAttachments instance itself
   */
  public TweetAttachments putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mediaKeys, tweetAttachments.mediaKeys) &&
        ...
        Objects.equals(this.additionalProperties, tweetAttachments.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mediaKeys, pollIds, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetAttachments.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("poll_ids") != null && !jsonObj.get("poll_ids").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetAttachments>() {
           ...
           public TweetAttachments read(JsonReader in) throws IOException {
             ...
             TweetAttachments instance = thisAdapter.fromJsonTree(jsonObj);
