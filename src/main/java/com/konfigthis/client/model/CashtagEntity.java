...
public class CashtagEntity {
  ...
  **/
   ...
   * @return the CashtagEntity instance itself
   */
  public CashtagEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, cashtagEntity.end) &&
        ...
        Objects.equals(this.additionalProperties, cashtagEntity.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CashtagEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CashtagEntity>() {
           ...
           public CashtagEntity read(JsonReader in) throws IOException {
             ...
             CashtagEntity instance = thisAdapter.fromJsonTree(jsonObj);
