 ...
 */
@ApiModel(description = "Engagement metrics for the Tweet at the time of the request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TweetPublicMetrics {
  ...
  **/
   ...
   * @return the TweetPublicMetrics instance itself
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(impressionCount, likeCount, quoteCount, replyCount, retweetCount, additionalProperties);
  }
