 ...
 */
@ApiModel(description = "A problem that indicates you are not allowed to see a particular Tweet, User, etc.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ResourceUnauthorizedProblem extends Problem {
  ...
  **/
   ...
   * @return the ResourceUnauthorizedProblem instance itself
   */
