 ...
 */
@ApiModel(description = "IDs and values of all deleted user-specified stream filtering rules.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DeleteRulesRequestDelete {
  ...
  **/
   ...
   * @return the DeleteRulesRequestDelete instance itself
   */
