 ...
 */
@ApiModel(description = "A problem that indicates that you are not allowed to see a particular field on a Tweet, User, etc.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FieldUnauthorizedProblem extends Problem {
  ...
  **/
   ...
   * @return the FieldUnauthorizedProblem instance itself
   */
  public FieldUnauthorizedProblem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.field, fieldUnauthorizedProblem.field) &&
        ...
        Objects.equals(this.additionalProperties, fieldUnauthorizedProblem.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(field, resourceType, section, super.hashCode(), additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FieldUnauthorizedProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FieldUnauthorizedProblem>() {
           ...
           public FieldUnauthorizedProblem read(JsonReader in) throws IOException {
             ...
             FieldUnauthorizedProblem instance = thisAdapter.fromJsonTree(jsonObj);
