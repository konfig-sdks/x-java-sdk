...
public class ListPinnedResponseData {
  ...
  **/
   ...
   * @return the ListPinnedResponseData instance itself
   */
  public ListPinnedResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pinned, listPinnedResponseData.pinned)&&
        Objects.equals(this.additionalProperties, listPinnedResponseData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pinned, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListPinnedResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListPinnedResponseData>() {
           ...
           public ListPinnedResponseData read(JsonReader in) throws IOException {
             ...
             ListPinnedResponseData instance = thisAdapter.fromJsonTree(jsonObj);
