...
public class TweetHideResponseData {
  ...
  **/
   ...
   * @return the TweetHideResponseData instance itself
   */
  public TweetHideResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hidden, tweetHideResponseData.hidden)&&
        Objects.equals(this.additionalProperties, tweetHideResponseData.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetHideResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetHideResponseData>() {
           ...
           public TweetHideResponseData read(JsonReader in) throws IOException {
             ...
             TweetHideResponseData instance = thisAdapter.fromJsonTree(jsonObj);
