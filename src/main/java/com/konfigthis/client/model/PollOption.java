 ...
 */
@ApiModel(description = "Describes a choice in a Poll object.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PollOption {
  ...
  public PollOption label(String label) {
    ...
    if (label != null && label.length() < 1) {
      throw new IllegalArgumentException("Invalid value for label. Length must be greater than or equal to 1.");
    }
  ...
  **/
   ...
   * @return the PollOption instance itself
   */
  public PollOption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, pollOption.label) &&
        ...
        Objects.equals(this.additionalProperties, pollOption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, position, votes, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PollOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PollOption>() {
           ...
           public PollOption read(JsonReader in) throws IOException {
             ...
             PollOption instance = thisAdapter.fromJsonTree(jsonObj);
