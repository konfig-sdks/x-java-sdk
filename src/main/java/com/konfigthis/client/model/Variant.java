...
public class Variant {
  ...
  **/
   ...
   * @return the Variant instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bitRate, variant.bitRate) &&
        ...
        Objects.equals(this.additionalProperties, variant.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bitRate, contentType, url, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Variant>() {
           ...
           public Variant read(JsonReader in) throws IOException {
             ...
             Variant instance = thisAdapter.fromJsonTree(jsonObj);
