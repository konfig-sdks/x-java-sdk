 ...
 */
@ApiModel(description = "A [GeoJson Point](https://tools.ietf.org/html/rfc7946#section-3.1.2) geometry object.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Point {
 ...
 public enum TypeEnum {
  ...
  public Point coordinates(List<Double> coordinates) {
  ...
  public Point addCoordinatesItem(Double coordinatesItem) {
  ...
  **/
   ...
   * @return the Point instance itself
   */
  public Point putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.coordinates, point.coordinates) &&
        ...
        Objects.equals(this.additionalProperties, point.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(coordinates, type, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Point>() {
           ...
           public Point read(JsonReader in) throws IOException {
             ...
             Point instance = thisAdapter.fromJsonTree(jsonObj);
