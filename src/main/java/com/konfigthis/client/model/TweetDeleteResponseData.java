...
public class TweetDeleteResponseData {
  ...
  **/
   ...
   * @return the TweetDeleteResponseData instance itself
   */
  public TweetDeleteResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleted, tweetDeleteResponseData.deleted)&&
        Objects.equals(this.additionalProperties, tweetDeleteResponseData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deleted, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetDeleteResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetDeleteResponseData>() {
           ...
           public TweetDeleteResponseData read(JsonReader in) throws IOException {
             ...
             TweetDeleteResponseData instance = thisAdapter.fromJsonTree(jsonObj);
