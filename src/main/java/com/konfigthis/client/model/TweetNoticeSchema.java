...
import com.konfigthis.client.model.TweetNotice;
...
public class TweetNoticeSchema {
  ...
  **/
   ...
   * @return the TweetNoticeSchema instance itself
   */
  public TweetNoticeSchema putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.publicTweetNotice, tweetNoticeSchema.publicTweetNotice)&&
        Objects.equals(this.additionalProperties, tweetNoticeSchema.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publicTweetNotice, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetNoticeSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetNoticeSchema>() {
           ...
           public TweetNoticeSchema read(JsonReader in) throws IOException {
             ...
             TweetNoticeSchema instance = thisAdapter.fromJsonTree(jsonObj);
