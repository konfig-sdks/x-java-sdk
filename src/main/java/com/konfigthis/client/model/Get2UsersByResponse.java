...
public class Get2UsersByResponse {
  ...
  **/
   ...
   * @return the Get2UsersByResponse instance itself
   */
  public Get2UsersByResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, get2UsersByResponse.data) &&
        ...
        Objects.equals(this.additionalProperties, get2UsersByResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Get2UsersByResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Get2UsersByResponse>() {
           ...
           public Get2UsersByResponse read(JsonReader in) throws IOException {
             ...
             Get2UsersByResponse instance = thisAdapter.fromJsonTree(jsonObj);
