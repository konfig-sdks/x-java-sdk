 ...
 */
@ApiModel(description = "A problem that indicates your client is forbidden from making this request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ClientForbiddenProblem extends Problem {
  ...
  **/
   ...
   * @return the ClientForbiddenProblem instance itself
   */
