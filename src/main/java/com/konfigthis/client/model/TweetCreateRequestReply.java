 ...
 */
@ApiModel(description = "Tweet information of the Tweet being replied to.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TweetCreateRequestReply {
  ...
  **/
   ...
   * @return the TweetCreateRequestReply instance itself
   */
  public TweetCreateRequestReply putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.excludeReplyUserIds, tweetCreateRequestReply.excludeReplyUserIds) &&
        ...
        Objects.equals(this.additionalProperties, tweetCreateRequestReply.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(excludeReplyUserIds, inReplyToTweetId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TweetCreateRequestReply.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TweetCreateRequestReply>() {
           ...
           public TweetCreateRequestReply read(JsonReader in) throws IOException {
             ...
             TweetCreateRequestReply instance = thisAdapter.fromJsonTree(jsonObj);
