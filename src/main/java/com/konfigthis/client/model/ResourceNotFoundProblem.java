 ...
 */
@ApiModel(description = "A problem that indicates that a given Tweet, User, etc. does not exist.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ResourceNotFoundProblem extends Problem {
 ...
 public enum ResourceTypeEnum {
  ...
  public ResourceNotFoundProblem parameter(String parameter) {
    ...
    if (parameter != null && parameter.length() < 1) {
      throw new IllegalArgumentException("Invalid value for parameter. Length must be greater than or equal to 1.");
    }
  ...
  **/
   ...
   * @return the ResourceNotFoundProblem instance itself
   */
  public ResourceNotFoundProblem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parameter, resourceNotFoundProblem.parameter) &&
        ...
        Objects.equals(this.additionalProperties, resourceNotFoundProblem.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parameter, resourceId, resourceType, value, super.hashCode(), additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResourceNotFoundProblem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResourceNotFoundProblem>() {
           ...
           public ResourceNotFoundProblem read(JsonReader in) throws IOException {
             ...
             ResourceNotFoundProblem instance = thisAdapter.fromJsonTree(jsonObj);
