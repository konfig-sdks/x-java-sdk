 ...
 */
@ApiModel(description = "Promoted nonpublic engagement metrics for the Media at the time of the request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VideoAllOfPromotedMetrics {
  ...
  **/
   ...
   * @return the VideoAllOfPromotedMetrics instance itself
   */
  public VideoAllOfPromotedMetrics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.playback0Count, videoAllOfPromotedMetrics.playback0Count) &&
        ...
        Objects.equals(this.additionalProperties, videoAllOfPromotedMetrics.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VideoAllOfPromotedMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VideoAllOfPromotedMetrics>() {
           ...
           public VideoAllOfPromotedMetrics read(JsonReader in) throws IOException {
             ...
             VideoAllOfPromotedMetrics instance = thisAdapter.fromJsonTree(jsonObj);
