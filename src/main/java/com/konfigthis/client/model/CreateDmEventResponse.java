...
import com.konfigthis.client.model.CreateDmEventResponseData;
...
public class CreateDmEventResponse {
  ...
  **/
   ...
   * @return the CreateDmEventResponse instance itself
   */
  public CreateDmEventResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createDmEventResponse.data) &&
        ...
        Objects.equals(this.additionalProperties, createDmEventResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateDmEventResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateDmEventResponse>() {
           ...
           public CreateDmEventResponse read(JsonReader in) throws IOException {
             ...
             CreateDmEventResponse instance = thisAdapter.fromJsonTree(jsonObj);
