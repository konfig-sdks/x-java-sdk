...
import com.konfigthis.client.model.SpaceTopicsInner;
...
public class Space {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2021-07-14T04:35:55Z", value = "When the Space was started as a date string.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2021-07-14T04:35:55Z", value = "When the Space was last updated.")
  ...
  public boolean equals(Object o) {
    ...
    Space space = (Space) o;
    return Objects.equals(this.title, space.title) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, createdAt, creatorId, endedAt, hostIds, id, invitedUserIds, isTicketed, lang, participantCount, scheduledStart, speakerIds, startedAt, state, subscriberCount, topics, updatedAt, additionalProperties);
  }
