...
public class BookmarkMutationResponseData {
  ...
  **/
   ...
   * @return the BookmarkMutationResponseData instance itself
   */
  public BookmarkMutationResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bookmarked, bookmarkMutationResponseData.bookmarked)&&
        Objects.equals(this.additionalProperties, bookmarkMutationResponseData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bookmarked, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BookmarkMutationResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BookmarkMutationResponseData>() {
           ...
           public BookmarkMutationResponseData read(JsonReader in) throws IOException {
             ...
             BookmarkMutationResponseData instance = thisAdapter.fromJsonTree(jsonObj);
