...
public class VideoAllOf {
  ...
  **/
   ...
   * @return the VideoAllOf instance itself
   */
  public VideoAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.durationMs, videoAllOf.durationMs) &&
        ...
        Objects.equals(this.additionalProperties, videoAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(durationMs, nonPublicMetrics, organicMetrics, previewImageUrl, promotedMetrics, publicMetrics, variants, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VideoAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if ((jsonObj.get("preview_image_url") != null && !jsonObj.get("preview_image_url").isJsonNull()) && !jsonObj.get("preview_image_url").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VideoAllOf>() {
           ...
           public VideoAllOf read(JsonReader in) throws IOException {
             ...
             VideoAllOf instance = thisAdapter.fromJsonTree(jsonObj);
