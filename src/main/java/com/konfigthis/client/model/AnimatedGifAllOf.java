...
public class AnimatedGifAllOf {
  ...
  **/
   ...
   * @return the AnimatedGifAllOf instance itself
   */
  public AnimatedGifAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.previewImageUrl, animatedGifAllOf.previewImageUrl) &&
        ...
        Objects.equals(this.additionalProperties, animatedGifAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(previewImageUrl, variants, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnimatedGifAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnimatedGifAllOf>() {
           ...
           public AnimatedGifAllOf read(JsonReader in) throws IOException {
             ...
             AnimatedGifAllOf instance = thisAdapter.fromJsonTree(jsonObj);
