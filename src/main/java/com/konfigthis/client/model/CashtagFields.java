 ...
 */
@ApiModel(description = "Represent the portion of text recognized as a Cashtag, and its start and end position within the text.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CashtagFields {
  ...
  **/
   ...
   * @return the CashtagFields instance itself
   */
  public CashtagFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tag, cashtagFields.tag)&&
        Objects.equals(this.additionalProperties, cashtagFields.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CashtagFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CashtagFields>() {
           ...
           public CashtagFields read(JsonReader in) throws IOException {
             ...
             CashtagFields instance = thisAdapter.fromJsonTree(jsonObj);
