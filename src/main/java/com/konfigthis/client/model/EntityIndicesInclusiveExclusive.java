 ...
 */
@ApiModel(description = "Represent a boundary range (start and end index) for a recognized entity (for example a hashtag or a mention). `start` must be smaller than `end`.  The start index is inclusive, the end index is exclusive.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class EntityIndicesInclusiveExclusive {
  ...
  **/
   ...
   * @return the EntityIndicesInclusiveExclusive instance itself
   */
  public EntityIndicesInclusiveExclusive putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, entityIndicesInclusiveExclusive.end) &&
        ...
        Objects.equals(this.additionalProperties, entityIndicesInclusiveExclusive.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EntityIndicesInclusiveExclusive.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EntityIndicesInclusiveExclusive>() {
           ...
           public EntityIndicesInclusiveExclusive read(JsonReader in) throws IOException {
             ...
             EntityIndicesInclusiveExclusive instance = thisAdapter.fromJsonTree(jsonObj);
