...
import com.konfigthis.client.model.ContextAnnotationDomainFields;
import com.konfigthis.client.model.ContextAnnotationEntityFields;
 ...
 */
@ApiModel(description = "Annotation inferred from the Tweet text.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ContextAnnotation {
  ...
  **/
   ...
   * @return the ContextAnnotation instance itself
   */
  public ContextAnnotation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domain, contextAnnotation.domain) &&
        ...
        Objects.equals(this.additionalProperties, contextAnnotation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, entity, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContextAnnotation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContextAnnotation>() {
           ...
           public ContextAnnotation read(JsonReader in) throws IOException {
             ...
             ContextAnnotation instance = thisAdapter.fromJsonTree(jsonObj);
