 ...
 */
@ApiModel(description = "Represent the portion of text recognized as a User mention, and its start and end position within the text.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class MentionFields {
  ...
  **/
   ...
   * @return the MentionFields instance itself
   */
  public MentionFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, mentionFields.id) &&
        ...
        Objects.equals(this.additionalProperties, mentionFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, username, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MentionFields>() {
           ...
           public MentionFields read(JsonReader in) throws IOException {
             ...
             MentionFields instance = thisAdapter.fromJsonTree(jsonObj);
